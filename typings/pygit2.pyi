...
from pygit2.index import Index  # pyright: ignore[reportMissingTypeStubs]
...
class Object:
    ...
    raw_name: bytes | None
    short_id: str
    type: "Literal[1] | Literal[2] | Literal[3] | Literal[4]"
    type_str: "Literal['commit'] | Literal['tree'] | Literal['tag'] | Literal['blob']"
    @overload
    def peel(self, target_type: "Literal[1]") -> "Commit": ...
    @overload
    def peel(self, target_type: "Literal[2]") -> "Tree": ...
    @overload
    def peel(self, target_type: "Literal[4]") -> "Tag": ...
    @overload
    def peel(self, target_type: "Literal[3]") -> "Blob": ...
    @overload
...
class Reference:
    ...
    @overload
    def peel(self, type: "Literal[1]") -> "Commit": ...
    @overload
    def peel(self, type: "Literal[2]") -> "Tree": ...
    @overload
    def peel(self, type: "Literal[4]") -> "Tag": ...
    @overload
    def peel(self, type: "Literal[3]") -> "Blob": ...
    @overload
...
class Diff:
    ...
    @staticmethod
    def from_c(diff: Diff, repo: Repository) -> Diff: ...
    @staticmethod
